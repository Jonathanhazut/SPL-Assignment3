...
public class MessageEncDec implements MessageEncoderDecoder<Command> {
    ...
    private Command[] commands = {new AdminRegCommand("username", "password"),
            new StudentRegCommand("password","username"),
            new LoginCommand("password","username"),
            new LogoutCommand(), new CourseRegCommand((short)5),new KdamCheckCommand((short)6),
            new CourseStatCommand((short)7), new StudentStatCommand("username"),
            new IsRegisteredCommand((short)9), new UnregisterCommand((short)10), new MyCoursesCommand()}; // TODO should be deleted.
